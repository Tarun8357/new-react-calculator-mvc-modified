    ...
    let operationalButtons = [{type:"OPERATOR",value:"ADD",sign:"+"},{type:"OPERATOR",value:"MULTIPLY",sign:"x"},{type:"OPERATOR",value:"SUBSTRACT",sign:"-"},{type:"OPERATOR",value:"DIVIDE",sign:"/"},{type:"OPERATOR",value:"EQUALS",sign:"="}];
